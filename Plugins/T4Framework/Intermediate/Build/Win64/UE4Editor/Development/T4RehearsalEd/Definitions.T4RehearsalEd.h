...
#define UE_PROJECT_NAME Tech4Demo
...
#define T4REHEARSALED_API DLLEXPORT
#define T4CORE_API DLLIMPORT
#define T4ENGINE_API DLLIMPORT
#define T4FRAMEWORK_API DLLIMPORT
#define T4GAMEPLAY_API DLLIMPORT
#define T4ASSETED_API DLLIMPORT
