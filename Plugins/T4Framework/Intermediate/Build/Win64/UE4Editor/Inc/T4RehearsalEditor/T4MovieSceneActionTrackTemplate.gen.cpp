...
#include "T4RehearsalEditor/Private/MainFrame/Sequencer/MovieScene/T4MovieSceneActionTrackTemplate.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	T4REHEARSALEDITOR_API UScriptStruct* Z_Construct_UScriptStruct_FT4MovieSceneActionTrackImplementation();
	...
	T4REHEARSALEDITOR_API UScriptStruct* Z_Construct_UScriptStruct_FT4MovieSceneActionTrackTemplate();
...
class UScriptStruct* FT4MovieSceneActionTrackImplementation::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern T4REHEARSALEDITOR_API uint32 Get_Z_Construct_UScriptStruct_FT4MovieSceneActionTrackImplementation_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FT4MovieSceneActionTrackImplementation, Z_Construct_UPackage__Script_T4RehearsalEditor(), TEXT("T4MovieSceneActionTrackImplementation"), sizeof(FT4MovieSceneActionTrackImplementation), Get_Z_Construct_UScriptStruct_FT4MovieSceneActionTrackImplementation_Hash());
	}
	return Singleton;
}
template<> T4REHEARSALEDITOR_API UScriptStruct* StaticStruct<FT4MovieSceneActionTrackImplementation>()
{
	return FT4MovieSceneActionTrackImplementation::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FT4MovieSceneActionTrackImplementation(FT4MovieSceneActionTrackImplementation::StaticStruct, TEXT("/Script/T4RehearsalEditor"), TEXT("T4MovieSceneActionTrackImplementation"), false, nullptr, nullptr);
static struct FScriptStruct_T4RehearsalEditor_StaticRegisterNativesFT4MovieSceneActionTrackImplementation
{
	FScriptStruct_T4RehearsalEditor_StaticRegisterNativesFT4MovieSceneActionTrackImplementation()
	{
...
} ScriptStruct_T4RehearsalEditor_StaticRegisterNativesFT4MovieSceneActionTrackImplementation;
	...
	UScriptStruct* Z_Construct_UScriptStruct_FT4MovieSceneActionTrackImplementation()
	{
		...
		UPackage* Outer = Z_Construct_UPackage__Script_T4RehearsalEditor();
	...
	uint32 Get_Z_Construct_UScriptStruct_FT4MovieSceneActionTrackImplementation_Hash() { return 493566148U; }
class UScriptStruct* FT4MovieSceneActionTrackTemplate::StaticStruct()
{
	static class UScriptStruct* Singleton = NULL;
	if (!Singleton)
	{
		extern T4REHEARSALEDITOR_API uint32 Get_Z_Construct_UScriptStruct_FT4MovieSceneActionTrackTemplate_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FT4MovieSceneActionTrackTemplate, Z_Construct_UPackage__Script_T4RehearsalEditor(), TEXT("T4MovieSceneActionTrackTemplate"), sizeof(FT4MovieSceneActionTrackTemplate), Get_Z_Construct_UScriptStruct_FT4MovieSceneActionTrackTemplate_Hash());
	}
	return Singleton;
}
template<> T4REHEARSALEDITOR_API UScriptStruct* StaticStruct<FT4MovieSceneActionTrackTemplate>()
{
	return FT4MovieSceneActionTrackTemplate::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FT4MovieSceneActionTrackTemplate(FT4MovieSceneActionTrackTemplate::StaticStruct, TEXT("/Script/T4RehearsalEditor"), TEXT("T4MovieSceneActionTrackTemplate"), false, nullptr, nullptr);
static struct FScriptStruct_T4RehearsalEditor_StaticRegisterNativesFT4MovieSceneActionTrackTemplate
{
	FScriptStruct_T4RehearsalEditor_StaticRegisterNativesFT4MovieSceneActionTrackTemplate()
	{
...
} ScriptStruct_T4RehearsalEditor_StaticRegisterNativesFT4MovieSceneActionTrackTemplate;
	...
	uint32 Get_Z_Construct_UScriptStruct_FT4MovieSceneActionTrackTemplate_Hash() { return 365369311U; }
