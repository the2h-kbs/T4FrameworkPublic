...
#include "T4Framework/Classes/Content/T4ContentTable_Effect.h"
#ifdef _MSC_VER
#pragma warning (push)
...
class UScriptStruct* FT4ContentEffectTableRow::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern T4FRAMEWORK_API uint32 Get_Z_Construct_UScriptStruct_FT4ContentEffectTableRow_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FT4ContentEffectTableRow, Z_Construct_UPackage__Script_T4Framework(), TEXT("T4ContentEffectTableRow"), sizeof(FT4ContentEffectTableRow), Get_Z_Construct_UScriptStruct_FT4ContentEffectTableRow_Hash());
	}
	return Singleton;
}
template<> T4FRAMEWORK_API UScriptStruct* StaticStruct<FT4ContentEffectTableRow>()
{
	return FT4ContentEffectTableRow::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FT4ContentEffectTableRow(FT4ContentEffectTableRow::StaticStruct, TEXT("/Script/T4Framework"), TEXT("T4ContentEffectTableRow"), false, nullptr, nullptr);
static struct FScriptStruct_T4Framework_StaticRegisterNativesFT4ContentEffectTableRow
{
	FScriptStruct_T4Framework_StaticRegisterNativesFT4ContentEffectTableRow()
	{
...
} ScriptStruct_T4Framework_StaticRegisterNativesFT4ContentEffectTableRow;
