...
#include "T4Framework/Public/Protocol/T4PacketSC_Move.h"
#ifdef _MSC_VER
#pragma warning (push)
...
class UScriptStruct* FT4PacketUnLockedSC::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern T4FRAMEWORK_API uint32 Get_Z_Construct_UScriptStruct_FT4PacketUnLockedSC_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FT4PacketUnLockedSC, Z_Construct_UPackage__Script_T4Framework(), TEXT("T4PacketUnLockedSC"), sizeof(FT4PacketUnLockedSC), Get_Z_Construct_UScriptStruct_FT4PacketUnLockedSC_Hash());
	}
	return Singleton;
}
template<> T4FRAMEWORK_API UScriptStruct* StaticStruct<FT4PacketUnLockedSC>()
{
	return FT4PacketUnLockedSC::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FT4PacketUnLockedSC(FT4PacketUnLockedSC::StaticStruct, TEXT("/Script/T4Framework"), TEXT("T4PacketUnLockedSC"), false, nullptr, nullptr);
static struct FScriptStruct_T4Framework_StaticRegisterNativesFT4PacketUnLockedSC
{
	FScriptStruct_T4Framework_StaticRegisterNativesFT4PacketUnLockedSC()
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("T4PacketUnLockedSC")),new UScriptStruct::TCppStructOps<FT4PacketUnLockedSC>);
	}
} ScriptStruct_T4Framework_StaticRegisterNativesFT4PacketUnLockedSC;
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FT4PacketUnLockedSC_Statics::Struct_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/Protocol/T4PacketSC_Move.h" },
	};
#endif
	...
	uint32 Get_Z_Construct_UScriptStruct_FT4PacketUnLockedSC_Hash() { return 3230936367U; }
class UScriptStruct* FT4PacketLockedSC::StaticStruct()
{
	static class UScriptStruct* Singleton = NULL;
	if (!Singleton)
	{
		extern T4FRAMEWORK_API uint32 Get_Z_Construct_UScriptStruct_FT4PacketLockedSC_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FT4PacketLockedSC, Z_Construct_UPackage__Script_T4Framework(), TEXT("T4PacketLockedSC"), sizeof(FT4PacketLockedSC), Get_Z_Construct_UScriptStruct_FT4PacketLockedSC_Hash());
	}
	return Singleton;
}
template<> T4FRAMEWORK_API UScriptStruct* StaticStruct<FT4PacketLockedSC>()
{
	return FT4PacketLockedSC::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FT4PacketLockedSC(FT4PacketLockedSC::StaticStruct, TEXT("/Script/T4Framework"), TEXT("T4PacketLockedSC"), false, nullptr, nullptr);
static struct FScriptStruct_T4Framework_StaticRegisterNativesFT4PacketLockedSC
{
	FScriptStruct_T4Framework_StaticRegisterNativesFT4PacketLockedSC()
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("T4PacketLockedSC")),new UScriptStruct::TCppStructOps<FT4PacketLockedSC>);
	}
} ScriptStruct_T4Framework_StaticRegisterNativesFT4PacketLockedSC;
	...
	uint32 Get_Z_Construct_UScriptStruct_FT4PacketLockedSC_Hash() { return 2411110851U; }
class UScriptStruct* FT4PacketTeleportToSC::StaticStruct()
{
	static class UScriptStruct* Singleton = NULL;
	if (!Singleton)
	{
		extern T4FRAMEWORK_API uint32 Get_Z_Construct_UScriptStruct_FT4PacketTeleportToSC_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FT4PacketTeleportToSC, Z_Construct_UPackage__Script_T4Framework(), TEXT("T4PacketTeleportToSC"), sizeof(FT4PacketTeleportToSC), Get_Z_Construct_UScriptStruct_FT4PacketTeleportToSC_Hash());
	}
	return Singleton;
}
template<> T4FRAMEWORK_API UScriptStruct* StaticStruct<FT4PacketTeleportToSC>()
{
	return FT4PacketTeleportToSC::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FT4PacketTeleportToSC(FT4PacketTeleportToSC::StaticStruct, TEXT("/Script/T4Framework"), TEXT("T4PacketTeleportToSC"), false, nullptr, nullptr);
static struct FScriptStruct_T4Framework_StaticRegisterNativesFT4PacketTeleportToSC
{
	FScriptStruct_T4Framework_StaticRegisterNativesFT4PacketTeleportToSC()
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("T4PacketTeleportToSC")),new UScriptStruct::TCppStructOps<FT4PacketTeleportToSC>);
	}
} ScriptStruct_T4Framework_StaticRegisterNativesFT4PacketTeleportToSC;
	...
	uint32 Get_Z_Construct_UScriptStruct_FT4PacketTeleportToSC_Hash() { return 139701221U; }
class UScriptStruct* FT4PacketJumpToSC::StaticStruct()
{
	static class UScriptStruct* Singleton = NULL;
	if (!Singleton)
	{
		extern T4FRAMEWORK_API uint32 Get_Z_Construct_UScriptStruct_FT4PacketJumpToSC_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FT4PacketJumpToSC, Z_Construct_UPackage__Script_T4Framework(), TEXT("T4PacketJumpToSC"), sizeof(FT4PacketJumpToSC), Get_Z_Construct_UScriptStruct_FT4PacketJumpToSC_Hash());
	}
	return Singleton;
}
template<> T4FRAMEWORK_API UScriptStruct* StaticStruct<FT4PacketJumpToSC>()
{
	return FT4PacketJumpToSC::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FT4PacketJumpToSC(FT4PacketJumpToSC::StaticStruct, TEXT("/Script/T4Framework"), TEXT("T4PacketJumpToSC"), false, nullptr, nullptr);
static struct FScriptStruct_T4Framework_StaticRegisterNativesFT4PacketJumpToSC
{
	FScriptStruct_T4Framework_StaticRegisterNativesFT4PacketJumpToSC()
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("T4PacketJumpToSC")),new UScriptStruct::TCppStructOps<FT4PacketJumpToSC>);
	}
} ScriptStruct_T4Framework_StaticRegisterNativesFT4PacketJumpToSC;
	...
	uint32 Get_Z_Construct_UScriptStruct_FT4PacketJumpToSC_Hash() { return 1900802714U; }
class UScriptStruct* FT4PacketMoveToSC::StaticStruct()
{
	static class UScriptStruct* Singleton = NULL;
	if (!Singleton)
	{
		extern T4FRAMEWORK_API uint32 Get_Z_Construct_UScriptStruct_FT4PacketMoveToSC_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FT4PacketMoveToSC, Z_Construct_UPackage__Script_T4Framework(), TEXT("T4PacketMoveToSC"), sizeof(FT4PacketMoveToSC), Get_Z_Construct_UScriptStruct_FT4PacketMoveToSC_Hash());
	}
	return Singleton;
}
template<> T4FRAMEWORK_API UScriptStruct* StaticStruct<FT4PacketMoveToSC>()
{
	return FT4PacketMoveToSC::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FT4PacketMoveToSC(FT4PacketMoveToSC::StaticStruct, TEXT("/Script/T4Framework"), TEXT("T4PacketMoveToSC"), false, nullptr, nullptr);
static struct FScriptStruct_T4Framework_StaticRegisterNativesFT4PacketMoveToSC
{
	FScriptStruct_T4Framework_StaticRegisterNativesFT4PacketMoveToSC()
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("T4PacketMoveToSC")),new UScriptStruct::TCppStructOps<FT4PacketMoveToSC>);
	}
} ScriptStruct_T4Framework_StaticRegisterNativesFT4PacketMoveToSC;
	...
	uint32 Get_Z_Construct_UScriptStruct_FT4PacketMoveToSC_Hash() { return 2283138050U; }
