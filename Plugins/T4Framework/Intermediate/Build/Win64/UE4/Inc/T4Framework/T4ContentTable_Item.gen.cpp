...
#include "T4Framework/Classes/Content/T4ContentTable_Item.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	T4FRAMEWORK_API UScriptStruct* Z_Construct_UScriptStruct_FT4ContentItemTableRow();
...
class UScriptStruct* FT4ContentItemTableRow::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern T4FRAMEWORK_API uint32 Get_Z_Construct_UScriptStruct_FT4ContentItemTableRow_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FT4ContentItemTableRow, Z_Construct_UPackage__Script_T4Framework(), TEXT("T4ContentItemTableRow"), sizeof(FT4ContentItemTableRow), Get_Z_Construct_UScriptStruct_FT4ContentItemTableRow_Hash());
	}
	return Singleton;
}
template<> T4FRAMEWORK_API UScriptStruct* StaticStruct<FT4ContentItemTableRow>()
{
	return FT4ContentItemTableRow::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FT4ContentItemTableRow(FT4ContentItemTableRow::StaticStruct, TEXT("/Script/T4Framework"), TEXT("T4ContentItemTableRow"), false, nullptr, nullptr);
static struct FScriptStruct_T4Framework_StaticRegisterNativesFT4ContentItemTableRow
{
	FScriptStruct_T4Framework_StaticRegisterNativesFT4ContentItemTableRow()
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("T4ContentItemTableRow")),new UScriptStruct::TCppStructOps<FT4ContentItemTableRow>);
	}
} ScriptStruct_T4Framework_StaticRegisterNativesFT4ContentItemTableRow;
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FT4ContentItemTableRow_Statics::Struct_MetaDataParams[] = {
		{ "ModuleRelativePath", "Classes/Content/T4ContentTable_Item.h" },
	};
#endif
	...
	uint32 Get_Z_Construct_UScriptStruct_FT4ContentItemTableRow_Hash() { return 4039362699U; }
