...
#include "T4Framework/Public/Protocol/T4PacketBase.h"
#ifdef _MSC_VER
#pragma warning (push)
...
class UScriptStruct* FT4PacketStoC::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern T4FRAMEWORK_API uint32 Get_Z_Construct_UScriptStruct_FT4PacketStoC_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FT4PacketStoC, Z_Construct_UPackage__Script_T4Framework(), TEXT("T4PacketStoC"), sizeof(FT4PacketStoC), Get_Z_Construct_UScriptStruct_FT4PacketStoC_Hash());
	}
	return Singleton;
}
template<> T4FRAMEWORK_API UScriptStruct* StaticStruct<FT4PacketStoC>()
{
	return FT4PacketStoC::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FT4PacketStoC(FT4PacketStoC::StaticStruct, TEXT("/Script/T4Framework"), TEXT("T4PacketStoC"), false, nullptr, nullptr);
static struct FScriptStruct_T4Framework_StaticRegisterNativesFT4PacketStoC
{
	FScriptStruct_T4Framework_StaticRegisterNativesFT4PacketStoC()
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("T4PacketStoC")),new UScriptStruct::TCppStructOps<FT4PacketStoC>);
	}
} ScriptStruct_T4Framework_StaticRegisterNativesFT4PacketStoC;
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FT4PacketStoC_Statics::Struct_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/Protocol/T4PacketBase.h" },
	};
#endif
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FT4PacketStoC_Statics::NewProp_PacketSC = { "PacketSC", nullptr, (EPropertyFlags)0x0010000000020001, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FT4PacketStoC, PacketSC), Z_Construct_UEnum_T4Framework_ET4PacketStoC, METADATA_PARAMS(Z_Construct_UScriptStruct_FT4PacketStoC_Statics::NewProp_PacketSC_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FT4PacketStoC_Statics::NewProp_PacketSC_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FT4PacketStoC_Hash() { return 150285421U; }
class UScriptStruct* FT4PacketCtoS::StaticStruct()
{
	static class UScriptStruct* Singleton = NULL;
	if (!Singleton)
	{
		extern T4FRAMEWORK_API uint32 Get_Z_Construct_UScriptStruct_FT4PacketCtoS_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FT4PacketCtoS, Z_Construct_UPackage__Script_T4Framework(), TEXT("T4PacketCtoS"), sizeof(FT4PacketCtoS), Get_Z_Construct_UScriptStruct_FT4PacketCtoS_Hash());
	}
	return Singleton;
}
template<> T4FRAMEWORK_API UScriptStruct* StaticStruct<FT4PacketCtoS>()
{
	return FT4PacketCtoS::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FT4PacketCtoS(FT4PacketCtoS::StaticStruct, TEXT("/Script/T4Framework"), TEXT("T4PacketCtoS"), false, nullptr, nullptr);
static struct FScriptStruct_T4Framework_StaticRegisterNativesFT4PacketCtoS
{
	FScriptStruct_T4Framework_StaticRegisterNativesFT4PacketCtoS()
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("T4PacketCtoS")),new UScriptStruct::TCppStructOps<FT4PacketCtoS>);
	}
} ScriptStruct_T4Framework_StaticRegisterNativesFT4PacketCtoS;
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FT4PacketCtoS_Statics::NewProp_PacketCS = { "PacketCS", nullptr, (EPropertyFlags)0x0010000000020001, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FT4PacketCtoS, PacketCS), Z_Construct_UEnum_T4Framework_ET4PacketCtoS, METADATA_PARAMS(Z_Construct_UScriptStruct_FT4PacketCtoS_Statics::NewProp_PacketCS_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FT4PacketCtoS_Statics::NewProp_PacketCS_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FT4PacketCtoS_Hash() { return 1924060355U; }
