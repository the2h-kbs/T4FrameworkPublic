...
#include "T4Framework/Public/Protocol/T4PacketCS_Command.h"
#ifdef _MSC_VER
#pragma warning (push)
...
class UScriptStruct* FT4PacketCmdTeleportCS::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern T4FRAMEWORK_API uint32 Get_Z_Construct_UScriptStruct_FT4PacketCmdTeleportCS_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FT4PacketCmdTeleportCS, Z_Construct_UPackage__Script_T4Framework(), TEXT("T4PacketCmdTeleportCS"), sizeof(FT4PacketCmdTeleportCS), Get_Z_Construct_UScriptStruct_FT4PacketCmdTeleportCS_Hash());
	}
	return Singleton;
}
template<> T4FRAMEWORK_API UScriptStruct* StaticStruct<FT4PacketCmdTeleportCS>()
{
	return FT4PacketCmdTeleportCS::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FT4PacketCmdTeleportCS(FT4PacketCmdTeleportCS::StaticStruct, TEXT("/Script/T4Framework"), TEXT("T4PacketCmdTeleportCS"), false, nullptr, nullptr);
static struct FScriptStruct_T4Framework_StaticRegisterNativesFT4PacketCmdTeleportCS
{
	FScriptStruct_T4Framework_StaticRegisterNativesFT4PacketCmdTeleportCS()
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("T4PacketCmdTeleportCS")),new UScriptStruct::TCppStructOps<FT4PacketCmdTeleportCS>);
	}
} ScriptStruct_T4Framework_StaticRegisterNativesFT4PacketCmdTeleportCS;
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FT4PacketCmdTeleportCS_Statics::Struct_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/Protocol/T4PacketCS_Command.h" },
	};
#endif
	...
	uint32 Get_Z_Construct_UScriptStruct_FT4PacketCmdTeleportCS_Hash() { return 1925262661U; }
class UScriptStruct* FT4PacketCmdItemLeaveCS::StaticStruct()
{
	static class UScriptStruct* Singleton = NULL;
	if (!Singleton)
	{
		extern T4FRAMEWORK_API uint32 Get_Z_Construct_UScriptStruct_FT4PacketCmdItemLeaveCS_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FT4PacketCmdItemLeaveCS, Z_Construct_UPackage__Script_T4Framework(), TEXT("T4PacketCmdItemLeaveCS"), sizeof(FT4PacketCmdItemLeaveCS), Get_Z_Construct_UScriptStruct_FT4PacketCmdItemLeaveCS_Hash());
	}
	return Singleton;
}
template<> T4FRAMEWORK_API UScriptStruct* StaticStruct<FT4PacketCmdItemLeaveCS>()
{
	return FT4PacketCmdItemLeaveCS::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FT4PacketCmdItemLeaveCS(FT4PacketCmdItemLeaveCS::StaticStruct, TEXT("/Script/T4Framework"), TEXT("T4PacketCmdItemLeaveCS"), false, nullptr, nullptr);
static struct FScriptStruct_T4Framework_StaticRegisterNativesFT4PacketCmdItemLeaveCS
{
	FScriptStruct_T4Framework_StaticRegisterNativesFT4PacketCmdItemLeaveCS()
	{
...
} ScriptStruct_T4Framework_StaticRegisterNativesFT4PacketCmdItemLeaveCS;
	...
	uint32 Get_Z_Construct_UScriptStruct_FT4PacketCmdItemLeaveCS_Hash() { return 3479864255U; }
class UScriptStruct* FT4PacketCmdItemEnterCS::StaticStruct()
{
	static class UScriptStruct* Singleton = NULL;
	if (!Singleton)
	{
		extern T4FRAMEWORK_API uint32 Get_Z_Construct_UScriptStruct_FT4PacketCmdItemEnterCS_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FT4PacketCmdItemEnterCS, Z_Construct_UPackage__Script_T4Framework(), TEXT("T4PacketCmdItemEnterCS"), sizeof(FT4PacketCmdItemEnterCS), Get_Z_Construct_UScriptStruct_FT4PacketCmdItemEnterCS_Hash());
	}
	return Singleton;
}
template<> T4FRAMEWORK_API UScriptStruct* StaticStruct<FT4PacketCmdItemEnterCS>()
{
	return FT4PacketCmdItemEnterCS::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FT4PacketCmdItemEnterCS(FT4PacketCmdItemEnterCS::StaticStruct, TEXT("/Script/T4Framework"), TEXT("T4PacketCmdItemEnterCS"), false, nullptr, nullptr);
static struct FScriptStruct_T4Framework_StaticRegisterNativesFT4PacketCmdItemEnterCS
{
	FScriptStruct_T4Framework_StaticRegisterNativesFT4PacketCmdItemEnterCS()
	{
...
} ScriptStruct_T4Framework_StaticRegisterNativesFT4PacketCmdItemEnterCS;
	...
	uint32 Get_Z_Construct_UScriptStruct_FT4PacketCmdItemEnterCS_Hash() { return 3084269394U; }
class UScriptStruct* FT4PacketCmdFOLeaveCS::StaticStruct()
{
	static class UScriptStruct* Singleton = NULL;
	if (!Singleton)
	{
		extern T4FRAMEWORK_API uint32 Get_Z_Construct_UScriptStruct_FT4PacketCmdFOLeaveCS_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FT4PacketCmdFOLeaveCS, Z_Construct_UPackage__Script_T4Framework(), TEXT("T4PacketCmdFOLeaveCS"), sizeof(FT4PacketCmdFOLeaveCS), Get_Z_Construct_UScriptStruct_FT4PacketCmdFOLeaveCS_Hash());
	}
	return Singleton;
}
template<> T4FRAMEWORK_API UScriptStruct* StaticStruct<FT4PacketCmdFOLeaveCS>()
{
	return FT4PacketCmdFOLeaveCS::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FT4PacketCmdFOLeaveCS(FT4PacketCmdFOLeaveCS::StaticStruct, TEXT("/Script/T4Framework"), TEXT("T4PacketCmdFOLeaveCS"), false, nullptr, nullptr);
static struct FScriptStruct_T4Framework_StaticRegisterNativesFT4PacketCmdFOLeaveCS
{
	FScriptStruct_T4Framework_StaticRegisterNativesFT4PacketCmdFOLeaveCS()
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("T4PacketCmdFOLeaveCS")),new UScriptStruct::TCppStructOps<FT4PacketCmdFOLeaveCS>);
	}
} ScriptStruct_T4Framework_StaticRegisterNativesFT4PacketCmdFOLeaveCS;
	...
	uint32 Get_Z_Construct_UScriptStruct_FT4PacketCmdFOLeaveCS_Hash() { return 3801097483U; }
class UScriptStruct* FT4PacketCmdFOEnterCS::StaticStruct()
{
	static class UScriptStruct* Singleton = NULL;
	if (!Singleton)
	{
		extern T4FRAMEWORK_API uint32 Get_Z_Construct_UScriptStruct_FT4PacketCmdFOEnterCS_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FT4PacketCmdFOEnterCS, Z_Construct_UPackage__Script_T4Framework(), TEXT("T4PacketCmdFOEnterCS"), sizeof(FT4PacketCmdFOEnterCS), Get_Z_Construct_UScriptStruct_FT4PacketCmdFOEnterCS_Hash());
	}
	return Singleton;
}
template<> T4FRAMEWORK_API UScriptStruct* StaticStruct<FT4PacketCmdFOEnterCS>()
{
	return FT4PacketCmdFOEnterCS::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FT4PacketCmdFOEnterCS(FT4PacketCmdFOEnterCS::StaticStruct, TEXT("/Script/T4Framework"), TEXT("T4PacketCmdFOEnterCS"), false, nullptr, nullptr);
static struct FScriptStruct_T4Framework_StaticRegisterNativesFT4PacketCmdFOEnterCS
{
	FScriptStruct_T4Framework_StaticRegisterNativesFT4PacketCmdFOEnterCS()
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("T4PacketCmdFOEnterCS")),new UScriptStruct::TCppStructOps<FT4PacketCmdFOEnterCS>);
	}
} ScriptStruct_T4Framework_StaticRegisterNativesFT4PacketCmdFOEnterCS;
	...
	uint32 Get_Z_Construct_UScriptStruct_FT4PacketCmdFOEnterCS_Hash() { return 1603541609U; }
class UScriptStruct* FT4PacketCmdNPCLeaveCS::StaticStruct()
{
	static class UScriptStruct* Singleton = NULL;
	if (!Singleton)
	{
		extern T4FRAMEWORK_API uint32 Get_Z_Construct_UScriptStruct_FT4PacketCmdNPCLeaveCS_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FT4PacketCmdNPCLeaveCS, Z_Construct_UPackage__Script_T4Framework(), TEXT("T4PacketCmdNPCLeaveCS"), sizeof(FT4PacketCmdNPCLeaveCS), Get_Z_Construct_UScriptStruct_FT4PacketCmdNPCLeaveCS_Hash());
	}
	return Singleton;
}
template<> T4FRAMEWORK_API UScriptStruct* StaticStruct<FT4PacketCmdNPCLeaveCS>()
{
	return FT4PacketCmdNPCLeaveCS::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FT4PacketCmdNPCLeaveCS(FT4PacketCmdNPCLeaveCS::StaticStruct, TEXT("/Script/T4Framework"), TEXT("T4PacketCmdNPCLeaveCS"), false, nullptr, nullptr);
static struct FScriptStruct_T4Framework_StaticRegisterNativesFT4PacketCmdNPCLeaveCS
{
	FScriptStruct_T4Framework_StaticRegisterNativesFT4PacketCmdNPCLeaveCS()
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("T4PacketCmdNPCLeaveCS")),new UScriptStruct::TCppStructOps<FT4PacketCmdNPCLeaveCS>);
	}
} ScriptStruct_T4Framework_StaticRegisterNativesFT4PacketCmdNPCLeaveCS;
	...
	uint32 Get_Z_Construct_UScriptStruct_FT4PacketCmdNPCLeaveCS_Hash() { return 3114398769U; }
class UScriptStruct* FT4PacketCmdNPCEnterCS::StaticStruct()
{
	static class UScriptStruct* Singleton = NULL;
	if (!Singleton)
	{
		extern T4FRAMEWORK_API uint32 Get_Z_Construct_UScriptStruct_FT4PacketCmdNPCEnterCS_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FT4PacketCmdNPCEnterCS, Z_Construct_UPackage__Script_T4Framework(), TEXT("T4PacketCmdNPCEnterCS"), sizeof(FT4PacketCmdNPCEnterCS), Get_Z_Construct_UScriptStruct_FT4PacketCmdNPCEnterCS_Hash());
	}
	return Singleton;
}
template<> T4FRAMEWORK_API UScriptStruct* StaticStruct<FT4PacketCmdNPCEnterCS>()
{
	return FT4PacketCmdNPCEnterCS::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FT4PacketCmdNPCEnterCS(FT4PacketCmdNPCEnterCS::StaticStruct, TEXT("/Script/T4Framework"), TEXT("T4PacketCmdNPCEnterCS"), false, nullptr, nullptr);
static struct FScriptStruct_T4Framework_StaticRegisterNativesFT4PacketCmdNPCEnterCS
{
	FScriptStruct_T4Framework_StaticRegisterNativesFT4PacketCmdNPCEnterCS()
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("T4PacketCmdNPCEnterCS")),new UScriptStruct::TCppStructOps<FT4PacketCmdNPCEnterCS>);
	}
} ScriptStruct_T4Framework_StaticRegisterNativesFT4PacketCmdNPCEnterCS;
	...
	uint32 Get_Z_Construct_UScriptStruct_FT4PacketCmdNPCEnterCS_Hash() { return 1472818789U; }
class UScriptStruct* FT4PacketCmdPCLeaveCS::StaticStruct()
{
	static class UScriptStruct* Singleton = NULL;
	if (!Singleton)
	{
		extern T4FRAMEWORK_API uint32 Get_Z_Construct_UScriptStruct_FT4PacketCmdPCLeaveCS_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FT4PacketCmdPCLeaveCS, Z_Construct_UPackage__Script_T4Framework(), TEXT("T4PacketCmdPCLeaveCS"), sizeof(FT4PacketCmdPCLeaveCS), Get_Z_Construct_UScriptStruct_FT4PacketCmdPCLeaveCS_Hash());
	}
	return Singleton;
}
template<> T4FRAMEWORK_API UScriptStruct* StaticStruct<FT4PacketCmdPCLeaveCS>()
{
	return FT4PacketCmdPCLeaveCS::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FT4PacketCmdPCLeaveCS(FT4PacketCmdPCLeaveCS::StaticStruct, TEXT("/Script/T4Framework"), TEXT("T4PacketCmdPCLeaveCS"), false, nullptr, nullptr);
static struct FScriptStruct_T4Framework_StaticRegisterNativesFT4PacketCmdPCLeaveCS
{
	FScriptStruct_T4Framework_StaticRegisterNativesFT4PacketCmdPCLeaveCS()
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("T4PacketCmdPCLeaveCS")),new UScriptStruct::TCppStructOps<FT4PacketCmdPCLeaveCS>);
	}
} ScriptStruct_T4Framework_StaticRegisterNativesFT4PacketCmdPCLeaveCS;
	...
	uint32 Get_Z_Construct_UScriptStruct_FT4PacketCmdPCLeaveCS_Hash() { return 958412118U; }
class UScriptStruct* FT4PacketCmdPCEnterCS::StaticStruct()
{
	static class UScriptStruct* Singleton = NULL;
	if (!Singleton)
	{
		extern T4FRAMEWORK_API uint32 Get_Z_Construct_UScriptStruct_FT4PacketCmdPCEnterCS_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FT4PacketCmdPCEnterCS, Z_Construct_UPackage__Script_T4Framework(), TEXT("T4PacketCmdPCEnterCS"), sizeof(FT4PacketCmdPCEnterCS), Get_Z_Construct_UScriptStruct_FT4PacketCmdPCEnterCS_Hash());
	}
	return Singleton;
}
template<> T4FRAMEWORK_API UScriptStruct* StaticStruct<FT4PacketCmdPCEnterCS>()
{
	return FT4PacketCmdPCEnterCS::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FT4PacketCmdPCEnterCS(FT4PacketCmdPCEnterCS::StaticStruct, TEXT("/Script/T4Framework"), TEXT("T4PacketCmdPCEnterCS"), false, nullptr, nullptr);
static struct FScriptStruct_T4Framework_StaticRegisterNativesFT4PacketCmdPCEnterCS
{
	FScriptStruct_T4Framework_StaticRegisterNativesFT4PacketCmdPCEnterCS()
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("T4PacketCmdPCEnterCS")),new UScriptStruct::TCppStructOps<FT4PacketCmdPCEnterCS>);
	}
} ScriptStruct_T4Framework_StaticRegisterNativesFT4PacketCmdPCEnterCS;
	...
	uint32 Get_Z_Construct_UScriptStruct_FT4PacketCmdPCEnterCS_Hash() { return 2024477865U; }
class UScriptStruct* FT4PacketCmdChangeWorldCS::StaticStruct()
{
	static class UScriptStruct* Singleton = NULL;
	if (!Singleton)
	{
		extern T4FRAMEWORK_API uint32 Get_Z_Construct_UScriptStruct_FT4PacketCmdChangeWorldCS_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FT4PacketCmdChangeWorldCS, Z_Construct_UPackage__Script_T4Framework(), TEXT("T4PacketCmdChangeWorldCS"), sizeof(FT4PacketCmdChangeWorldCS), Get_Z_Construct_UScriptStruct_FT4PacketCmdChangeWorldCS_Hash());
	}
	return Singleton;
}
template<> T4FRAMEWORK_API UScriptStruct* StaticStruct<FT4PacketCmdChangeWorldCS>()
{
	return FT4PacketCmdChangeWorldCS::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FT4PacketCmdChangeWorldCS(FT4PacketCmdChangeWorldCS::StaticStruct, TEXT("/Script/T4Framework"), TEXT("T4PacketCmdChangeWorldCS"), false, nullptr, nullptr);
static struct FScriptStruct_T4Framework_StaticRegisterNativesFT4PacketCmdChangeWorldCS
{
	FScriptStruct_T4Framework_StaticRegisterNativesFT4PacketCmdChangeWorldCS()
	{
...
} ScriptStruct_T4Framework_StaticRegisterNativesFT4PacketCmdChangeWorldCS;
	...
	uint32 Get_Z_Construct_UScriptStruct_FT4PacketCmdChangeWorldCS_Hash() { return 2378596878U; }
