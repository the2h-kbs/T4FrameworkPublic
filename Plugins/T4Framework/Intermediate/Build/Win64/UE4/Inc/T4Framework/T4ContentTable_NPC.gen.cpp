...
#include "T4Framework/Classes/Content/T4ContentTable_NPC.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	T4FRAMEWORK_API UScriptStruct* Z_Construct_UScriptStruct_FT4ContentNPCTableRow();
...
class UScriptStruct* FT4ContentNPCTableRow::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern T4FRAMEWORK_API uint32 Get_Z_Construct_UScriptStruct_FT4ContentNPCTableRow_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FT4ContentNPCTableRow, Z_Construct_UPackage__Script_T4Framework(), TEXT("T4ContentNPCTableRow"), sizeof(FT4ContentNPCTableRow), Get_Z_Construct_UScriptStruct_FT4ContentNPCTableRow_Hash());
	}
	return Singleton;
}
template<> T4FRAMEWORK_API UScriptStruct* StaticStruct<FT4ContentNPCTableRow>()
{
	return FT4ContentNPCTableRow::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FT4ContentNPCTableRow(FT4ContentNPCTableRow::StaticStruct, TEXT("/Script/T4Framework"), TEXT("T4ContentNPCTableRow"), false, nullptr, nullptr);
static struct FScriptStruct_T4Framework_StaticRegisterNativesFT4ContentNPCTableRow
{
	FScriptStruct_T4Framework_StaticRegisterNativesFT4ContentNPCTableRow()
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("T4ContentNPCTableRow")),new UScriptStruct::TCppStructOps<FT4ContentNPCTableRow>);
	}
} ScriptStruct_T4Framework_StaticRegisterNativesFT4ContentNPCTableRow;
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FT4ContentNPCTableRow_Statics::Struct_MetaDataParams[] = {
		{ "ModuleRelativePath", "Classes/Content/T4ContentTable_NPC.h" },
	};
#endif
	...
	uint32 Get_Z_Construct_UScriptStruct_FT4ContentNPCTableRow_Hash() { return 3582947304U; }
