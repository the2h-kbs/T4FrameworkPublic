...
#include "T4Framework/Public/Protocol/T4PacketCS_Action.h"
#ifdef _MSC_VER
#pragma warning (push)
...
class UScriptStruct* FT4PacketAttackCS::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern T4FRAMEWORK_API uint32 Get_Z_Construct_UScriptStruct_FT4PacketAttackCS_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FT4PacketAttackCS, Z_Construct_UPackage__Script_T4Framework(), TEXT("T4PacketAttackCS"), sizeof(FT4PacketAttackCS), Get_Z_Construct_UScriptStruct_FT4PacketAttackCS_Hash());
	}
	return Singleton;
}
template<> T4FRAMEWORK_API UScriptStruct* StaticStruct<FT4PacketAttackCS>()
{
	return FT4PacketAttackCS::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FT4PacketAttackCS(FT4PacketAttackCS::StaticStruct, TEXT("/Script/T4Framework"), TEXT("T4PacketAttackCS"), false, nullptr, nullptr);
static struct FScriptStruct_T4Framework_StaticRegisterNativesFT4PacketAttackCS
{
	FScriptStruct_T4Framework_StaticRegisterNativesFT4PacketAttackCS()
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("T4PacketAttackCS")),new UScriptStruct::TCppStructOps<FT4PacketAttackCS>);
	}
} ScriptStruct_T4Framework_StaticRegisterNativesFT4PacketAttackCS;
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FT4PacketAttackCS_Statics::Struct_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/Protocol/T4PacketCS_Action.h" },
	...
	uint32 Get_Z_Construct_UScriptStruct_FT4PacketAttackCS_Hash() { return 7275203U; }
