...
#include "T4Framework/Classes/Content/T4ContentTable_World.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	T4FRAMEWORK_API UScriptStruct* Z_Construct_UScriptStruct_FT4ContentWorldTableRow();
...
class UScriptStruct* FT4ContentWorldTableRow::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern T4FRAMEWORK_API uint32 Get_Z_Construct_UScriptStruct_FT4ContentWorldTableRow_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FT4ContentWorldTableRow, Z_Construct_UPackage__Script_T4Framework(), TEXT("T4ContentWorldTableRow"), sizeof(FT4ContentWorldTableRow), Get_Z_Construct_UScriptStruct_FT4ContentWorldTableRow_Hash());
	}
	return Singleton;
}
template<> T4FRAMEWORK_API UScriptStruct* StaticStruct<FT4ContentWorldTableRow>()
{
	return FT4ContentWorldTableRow::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FT4ContentWorldTableRow(FT4ContentWorldTableRow::StaticStruct, TEXT("/Script/T4Framework"), TEXT("T4ContentWorldTableRow"), false, nullptr, nullptr);
static struct FScriptStruct_T4Framework_StaticRegisterNativesFT4ContentWorldTableRow
{
	FScriptStruct_T4Framework_StaticRegisterNativesFT4ContentWorldTableRow()
	{
...
} ScriptStruct_T4Framework_StaticRegisterNativesFT4ContentWorldTableRow;
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FT4ContentWorldTableRow_Statics::Struct_MetaDataParams[] = {
		{ "ModuleRelativePath", "Classes/Content/T4ContentTable_World.h" },
	};
#endif
	...
	uint32 Get_Z_Construct_UScriptStruct_FT4ContentWorldTableRow_Hash() { return 2136236941U; }
