...
#include "T4Gameplay/Private/Network/Protocol/T4PacketSC_Action.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	T4GAMEPLAY_API UScriptStruct* Z_Construct_UScriptStruct_FT4PacketEffectSC();
	...
	T4GAMEPLAY_API UScriptStruct* Z_Construct_UScriptStruct_FT4PacketAttackSC();
...
class UScriptStruct* FT4PacketEffectSC::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern T4GAMEPLAY_API uint32 Get_Z_Construct_UScriptStruct_FT4PacketEffectSC_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FT4PacketEffectSC, Z_Construct_UPackage__Script_T4Gameplay(), TEXT("T4PacketEffectSC"), sizeof(FT4PacketEffectSC), Get_Z_Construct_UScriptStruct_FT4PacketEffectSC_Hash());
	}
	return Singleton;
}
template<> T4GAMEPLAY_API UScriptStruct* StaticStruct<FT4PacketEffectSC>()
{
	return FT4PacketEffectSC::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FT4PacketEffectSC(FT4PacketEffectSC::StaticStruct, TEXT("/Script/T4Gameplay"), TEXT("T4PacketEffectSC"), false, nullptr, nullptr);
static struct FScriptStruct_T4Gameplay_StaticRegisterNativesFT4PacketEffectSC
{
	FScriptStruct_T4Gameplay_StaticRegisterNativesFT4PacketEffectSC()
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("T4PacketEffectSC")),new UScriptStruct::TCppStructOps<FT4PacketEffectSC>);
	}
} ScriptStruct_T4Gameplay_StaticRegisterNativesFT4PacketEffectSC;
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FT4PacketEffectSC_Statics::Struct_MetaDataParams[] = {
		{ "ModuleRelativePath", "Private/Network/Protocol/T4PacketSC_Action.h" },
	};
#endif
	...
	uint32 Get_Z_Construct_UScriptStruct_FT4PacketEffectSC_Hash() { return 3085613597U; }
class UScriptStruct* FT4PacketAttackSC::StaticStruct()
{
	static class UScriptStruct* Singleton = NULL;
	if (!Singleton)
	{
		extern T4GAMEPLAY_API uint32 Get_Z_Construct_UScriptStruct_FT4PacketAttackSC_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FT4PacketAttackSC, Z_Construct_UPackage__Script_T4Gameplay(), TEXT("T4PacketAttackSC"), sizeof(FT4PacketAttackSC), Get_Z_Construct_UScriptStruct_FT4PacketAttackSC_Hash());
	}
	return Singleton;
}
template<> T4GAMEPLAY_API UScriptStruct* StaticStruct<FT4PacketAttackSC>()
{
	return FT4PacketAttackSC::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FT4PacketAttackSC(FT4PacketAttackSC::StaticStruct, TEXT("/Script/T4Gameplay"), TEXT("T4PacketAttackSC"), false, nullptr, nullptr);
static struct FScriptStruct_T4Gameplay_StaticRegisterNativesFT4PacketAttackSC
{
	FScriptStruct_T4Gameplay_StaticRegisterNativesFT4PacketAttackSC()
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("T4PacketAttackSC")),new UScriptStruct::TCppStructOps<FT4PacketAttackSC>);
	}
} ScriptStruct_T4Gameplay_StaticRegisterNativesFT4PacketAttackSC;
	...
	uint32 Get_Z_Construct_UScriptStruct_FT4PacketAttackSC_Hash() { return 3686720267U; }
