...
USTRUCT()
struct T4FRAMEWORK_API FT4PacketMoveToSC : public FT4PacketStoC
{
...
USTRUCT()
struct T4FRAMEWORK_API FT4PacketJumpToSC : public FT4PacketStoC
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT()
struct T4FRAMEWORK_API FT4PacketTeleportToSC : public FT4PacketStoC
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT()
struct T4FRAMEWORK_API FT4PacketLockedSC : public FT4PacketStoC
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT()
struct T4FRAMEWORK_API FT4PacketUnLockedSC : public FT4PacketStoC
{
	GENERATED_USTRUCT_BODY()
