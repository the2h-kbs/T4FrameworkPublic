...
#if WITH_EDITOR
#include "T4ActionContiWithEditor.h"
#endif
#include "T4ActionContiAsset.generated.h"

/**
  * #24
 */
struct FT4ActionContiCustomVersion
{
	enum Type
	{
		InitializeVer = 0,
...
private:
	FT4ActionContiCustomVersion() {}
};

class UTexture2D;
UCLASS(ClassGroup = Tech4Labs, Category = "Tech4Labs", BlueprintType, Blueprintable)
class T4ENGINE_API UT4ActionContiAsset : public UObject
{
...
public:
	...
	static UT4ActionContiAsset* CreateAsset(const FString& InAssetName, const FString& InPackagePath);
