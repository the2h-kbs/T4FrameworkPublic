...
USTRUCT()
struct FT4PacketMoveWarmupCS : public FT4PacketCtoS
{
...
USTRUCT()
struct FT4PacketJumpWarmupCS : public FT4PacketCtoS
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT()
struct FT4PacketLockedCS : public FT4PacketCtoS
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT()
struct FT4PacketUnLockedCS : public FT4PacketCtoS
{
	GENERATED_USTRUCT_BODY()
