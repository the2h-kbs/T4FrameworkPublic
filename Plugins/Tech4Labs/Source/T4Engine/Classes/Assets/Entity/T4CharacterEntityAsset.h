...
USTRUCT()
struct T4ENGINE_API FT4EntityCharacterPhysicalAttribute : public FT4EntityBasePhysicalAttribute
{
...
USTRUCT()
struct T4ENGINE_API FT4EntityCharacterRenderingAttribute : public FT4EntityBaseRenderingAttribute
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT()
struct T4ENGINE_API FT4EntityCharacterFullBodyMeshData
{
	GENERATED_USTRUCT_BODY()
...
// #37
USTRUCT()
struct T4ENGINE_API FT4EntityCharacterCompositePartMeshData
{
	GENERATED_USTRUCT_BODY()
...
// #37
USTRUCT()
struct T4ENGINE_API FT4EntityCharacterCompositeMeshData
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT()
struct T4ENGINE_API FT4EntityCharacterAnimationData
{
	GENERATED_USTRUCT_BODY()
...
class T4ENGINE_API UT4CharacterEntityAsset : public UT4EntityAsset
{
